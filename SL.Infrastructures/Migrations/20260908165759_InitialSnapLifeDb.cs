...
{
    /// <inheritdoc />
    public partial class InitialSnapLifeDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SysActivityLogs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SysConfigurations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Stories_MediaFiles_FileId",
                        column: x => x.FileId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostMedias_MediaFiles_FileId",
                        column: x => x.FileId,
                        principalTable: "MediaFiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Posts_UserId_CreatedDate",
                table: "Posts",
                columns: new[] { "UserId", "CreatedDate" });

            migrationBuilder.CreateIndex(
                name: "IX_Reactions_UserId_TargetType_TargetId",
                table: "Reactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRelationships_SourceUserId_TargetUserId_Type",
                table: "UserRelationships",
                columns: new[] { "SourceUserId", "TargetUserId", "Type" },
                unique: true);
